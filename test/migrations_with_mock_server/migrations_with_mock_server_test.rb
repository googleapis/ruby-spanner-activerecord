...
module TestMigrationsWithMockServer
  ...
  class SpannerMigrationsMockServerTest < Minitest::Test
    ...
    def test_execute_migrations
      ...
      assert_equal(
        "CREATE TABLE `singers` (`singerid` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `first_name` STRING(200), `last_name` STRING(MAX)) PRIMARY KEY (`singerid`)",
    ...
    def test_execute_migration_without_batching
      ...
      assert_equal(
        "CREATE TABLE `table1` (`id` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `col1` STRING(MAX), `col2` STRING(MAX)) PRIMARY KEY (`id`)",
        ddl_requests[2].statements[0]
      )
      assert_equal(
        "CREATE TABLE `table2` (`id` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `col1` STRING(MAX), `col2` STRING(MAX)) PRIMARY KEY (`id`)",
    ...
    def test_create_all_native_migration_types
      ...
      expectedDdl << "`id` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), "
    ...
    def test_interleaved_table
      ...
      expectedDdl << "(`singerid` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `first_name` STRING(200), `last_name` STRING(MAX)) "
      expectedDdl << "PRIMARY KEY (`singerid`)"
      assert_equal expectedDdl, ddl_requests[2].statements[0]

      expectedDdl = "CREATE TABLE `albums` "
      expectedDdl << "(`albumid` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `singerid` INT64 NOT NULL, `title` STRING(MAX)"
      ...
      expectedDdl << "(`trackid` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `singerid` INT64 NOT NULL, `albumid` INT64 NOT NULL, `title` STRING(MAX), `duration` NUMERIC"
    ...
    if ActiveRecord::gem_version < Gem::Version.create('7.1.0')
      def test_interleaved_table_with_uuid_pk
        ...
        expectedDdl << "(`parentid` STRING(36) NOT NULL, `childid` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `title` STRING(MAX)) "
    ...
    def test_create_table_with_commit_timestamp
      ...
      expectedDdl << "(`id` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `value` STRING(MAX), `last_updated` TIMESTAMP OPTIONS (allow_commit_timestamp = true)) "
      expectedDdl << "PRIMARY KEY (`id`)"
      assert_equal expectedDdl, ddl_requests[2].statements[0]
    end
    ...
    def test_create_table_with_generated_column
      ...
      expectedDdl = "CREATE TABLE `singers` "
      expectedDdl << "(`id` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `first_name` STRING(100), `last_name` STRING(200), "
    ...
    def test_create_table_with_default_value
      ...
      expectedDdl = "CREATE TABLE `singers` "
      expectedDdl << "(`id` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `name` STRING(MAX) NOT NULL DEFAULT ('no name'), `age` INT64 NOT NULL DEFAULT (0)) "
      expectedDdl << "PRIMARY KEY (`id`)"
      assert_equal expectedDdl, ddl_requests[2].statements[0]
    end
    ...
    def test_create_table_with_identity
      context = migration_context

      register_version_result "1", "13"
      ...
      assert_equal "CREATE TABLE `table_with_identity` (`id` INT64 NOT NULL GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE), `name` STRING(MAX) NOT NULL, `age` INT64 NOT NULL) PRIMARY KEY (`id`)", ddl_requests[2].statements[0]
    end
