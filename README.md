...
This project provides a Cloud Spanner adapter for ActiveRecord. It has the __Preview__ release status and supports ActiveRecord 6.0.x/6.1.x with Ruby 2.6 or higher.
